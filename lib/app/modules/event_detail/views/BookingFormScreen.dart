...
class _BookingFormScreenState extends State<BookingFormScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    final body = {
      ...
      'special_requirements': _specialRequirements.text,
      'name': _name.text,
      'email': _email.text,
    ...
    try {
      final response = await http.post(
        Uri.parse(
          'http://10.0.2.2:8000/api/bookings/create',
        ), // Update if API is different
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              // _buildTextField('Special Requirements', _specialRequirements),
              Divider(),
              _buildTextField('Name', _name),
              _buildTextField('Email', _email, TextInputType.emailAddress),
